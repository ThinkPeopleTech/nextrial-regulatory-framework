...
> See [adapter-interface-spec-v3.md](adapter-interface-spec-v3.md) — the v3.0
> interface aligns the adapter output to the eight-property proof certificate
> (PASS/FAIL/REQUIRES_REVIEW; two attestation levels, no Level 3).
